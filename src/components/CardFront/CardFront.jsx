  ...
  return (
    <div className="card card-front" id="card-front" style={cardStyle}>
      ...
      <div className="card-front__info">
        ...
        <span className="card-front__info-label"
          style={{ fontSize: fontSizes['field-label'] + 'px' }}>
          Instituto
        </span>
        <p className="card-front__info-institution"
          style={{ fontSize: fontSizes.institution + 'px' }}>
          {displayInstituto}
        </p>
        ...
        <p className="card-front__info-name"
        ...
        <p className="card-front__info-value"
          style={{ fontSize: fontSizes['field-value'] + 'px' }}>
          {displayCurso}
        </p>
